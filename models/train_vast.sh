...
TRAIN_PATHS="/root/hcmus/SnapUGC/SnapUGC_0/snapugc0_nano_train_engcaption_image.json"
EVAL_PATHS="/root/hcmus/SnapUGC/SnapUGC_0/snapugc0_nano_val_engcaption_image.json"
