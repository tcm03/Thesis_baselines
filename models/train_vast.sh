#!/bin/bash
PATH_TO_FOLDERS="/root/hcmus/SnapUGC/SnapUGC_0"
TRAIN_PATHS="/root/hcmus/SnapUGC/SnapUGC_0/snapugc0_train_engcaption_image.json"
EVAL_PATHS="/root/hcmus/SnapUGC/SnapUGC_0/snapugc0_val_engcaption_image.json"

OUTPUT_DIR="./checkpoints/txt2txt_label_rationale_seq_balance"

CKPT_NAME="txt2txt_label_rationale_seq_balance"
